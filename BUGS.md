...
### BUG-140 — a human receives agent bust/funding language — FIXED on design branch, integration pending
...
### BUG-141 — mid-hand human join looks frozen; long between-hand pauses — FIXED on design branch, integration pending
...
### BUG-143 — Profile hides statistics, loses chat history, and read menus are hard to dismiss — FIXED on design branch, integration pending
...
### BUG-144 — showdown re-hides known board cards and can reveal unseen cards too early — FIXED on design branch, integration pending
