...
Seven real HTTP/SQLite regressions cover conservation, repeated retirement, deletion/reload, claim migration, legacy owners, reload refusal and transaction rollback. Observed reds: 20,000 instead of 10,000 after redrafting; reload pocket remained zero instead of 2,000. Server109 pass/two intentional skips and client2250 pass/two existing todos; e2e seven pass after updating old established-owner fixtures to seed spendable safe chips as well as earned slots. Those fixtures previously depended on the very per-agent mint being removed; no gameplay assertion changed. Actual built-browser journey and final integration remain pending.
