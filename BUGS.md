...
### BUG-160 — a visiting agent's Live profile cannot open its actual kitchen — FIXED on integration branch; built journey pending
...
### BUG-154 — table sheet confuses agent capacity with a human playing chair — OPEN
...
### BUG-155 — unrelated owners can enter and terminate another household's kitchen — OPEN, isolated repair underway
...
### BUG-149 — a host can move and stake another owner's agent without an invitation — OPEN
...
### BUG-151 — restart loses the visit record while the agent remains away — OPEN
...
### BUG-152 — a visiting departure can duplicate an agent still playing a Home hand — OPEN
...
### BUG-153 — visit acceptance ignores the immediate deadline and available chairs — OPEN
