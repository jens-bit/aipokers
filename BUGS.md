...
Named BUG headings: 175, including the two historically reused BUG-121 headings. Historical reports are retained; an OPEN section heading alone does not override an entry's verified FIXED status.

### BUG-183 — confirmed empty Home uses a named speaker instead of F01's system sentence — OPEN, isolated source port for batch51
...
### BUG-181 — Home's collapsed conversation band retains the old opaque glass tokens — OPEN, isolated source port for batch51
