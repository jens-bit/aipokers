...
Named BUG headings: 158, including the two historically reused BUG-121 headings. Historical reports are retained; an OPEN section heading alone does not override an entry's verified FIXED status.

### BUG-166 — Home name-pill text uses identity glow instead of the reference neutral ink — OPEN
