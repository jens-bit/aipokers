...
Named BUG headings: 187, including the two historically reused BUG-121 headings. Historical reports are retained; an OPEN section heading alone does not override an entry's verified FIXED status.

### BUG-195 — Home location and quiet-count text retain older dark grey ink — OPEN, isolated current-source port for53
...
### BUG-194 — an own-agent Away Watch refusal can leave desktop showing SHUFFLING — OPEN, separately reproduced during193
...
### BUG-193 — an owned agent visiting a friend's kitchen cannot open desktop Watch from its away card — FIXED in isolated4d1d5f4; reserved batch53
...
### BUG-192 — desktop away-agent Open does nothing when the agent has no live seat — FIXED in isolated eac7502; reserved batch53
...
### BUG-191 — the external Telegram SDK delays the first screen during normal entry — OPEN; parser blocking/readiness repaired in660988d, normal visible startup still slow
...
### BUG-187 — one isolated cold browser entry does not mount Home within five seconds — OPEN, unclassified local failure
...
### BUG-156 — entry bundle remains large despite fast local paint — OPEN, measured performance debt
