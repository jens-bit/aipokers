...
Batch44 fixes human loss/replay on phone and desktop, truthful mid-hand joining, three-second Home/watched hand gaps, known-card reveal, full all-in result lifecycle, Profile statistics and read dismissal. Owner conversation now has the authored nature and actual location context; live generated personality still needs playtesting. Existing ADMIN-1 work on main was preserved and included in verification. The combined design branch passes117 server checks,2285 client tests, seven gameplay e2e checks,124 Home/desktop/Watch browser checks, a fresh build, eight built smoke journeys and20 Home2 checks under Node22.22.2. Local main integration follows. Next: draft naming/stalls/repeated creation, honest safe failures and earned-seat explanations, then friend visits and the remaining design gaps. This is not a full release-readiness claim.
