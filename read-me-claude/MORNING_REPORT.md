...
**Latest checkpoint:** [NIGHT_2026-09-09.md](NIGHT_2026-09-09.md). Batch45 commits517372e/7faf6ae/035f05b repair earned-seat wording, saved four-stage drafts/naming/retries and honest safe reads/controls. Final118 server/2320 client/seven gameplay e2e, eight built smoke,20 Home2 and53 desktop checks pass; two real two-minute observations are in [PLAYTEST_2026-09-09.md](PLAYTEST_2026-09-09.md). Their new Home clarity bugs and confirmed visit consent/membership flaws are being repaired in isolated checkouts. The replacement design ledger lists individual frames and preserves the old grouped report as history. Current draft/safe pairs remain explicitly PARTIAL; no push or complete design-match claim.
...
Batch43 (5482953) fixes settled Home overlap, repeated recap bubbles and the missing separate roster icon. The household TV now admits one active study at a time. Red regressions preceded each correction;102 Home/desktop browser checks, eight built smoke journeys and20 Home2 checks passed. Main integration passed109 server checks,2255 client tests and all seven gameplay e2e checks, followed by a fresh build, eight built smoke journeys and20 Home2 checks. Actual phone/desktop crowded-room captures were inspected. Neither batch was pushed by Codex.

Batch44 at9bc5744 fixes human loss/replay on phone and desktop, truthful mid-hand joining, three-second Home/watched hand gaps, known-card reveal, full all-in result lifecycle, Profile statistics and read dismissal. Owner conversation now has the authored nature and actual location context; live generated personality still needs playtesting. Existing ADMIN-1 work on main was preserved and included in verification. Both the combined branch and local main passed117 server checks,2285 client tests and seven gameplay e2e checks, followed by fresh built smoke/Home2 checks. The combined browser pass covered124 Home/desktop/Watch cases. This is not a full release-readiness claim.
