...
2026-09-09 batch28: the desktop Watch example now captures the shared DkWatch canvas, current reasoning bubble and compact conversation, with exporter checks on condition-label clearance. The new owned Watch reference pair is in client/e2e/shots/design-batch28-owned.png.
