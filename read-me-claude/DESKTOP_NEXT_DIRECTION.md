...
Use the existing five-person playtest to judge progress. Record unaided completion, explanations of roles/whereabouts/result/next action, voluntary continuation and an actual later return separately. Automated playtests establish working routes, not enthusiasm or retention.
