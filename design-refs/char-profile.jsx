...
const PROFILE_CAST = {
  day1: {
    ...
    fatigue: null,
    attrs: [
      { k: 'READS', cur: 30, lo: 52, hi: 76 },
      { k: 'FOCUS', cur: 36, lo: 60, hi: 90 },
      { k: 'DISCIPLINE', cur: 50, lo: 82, hi: 96 },
      { k: 'COMPOSURE', cur: 33, lo: 55, hi: 74 },
      { k: 'DECEPTION', cur: 35, lo: 58, hi: 88 },
      { k: 'STAMINA', cur: 41, lo: 66, hi: 79 },
    ],
