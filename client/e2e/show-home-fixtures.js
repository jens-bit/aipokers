// Scripted HOME_STATE and authenticated routes for the built Home checks.
export const VIEWPORT = { width: 390, height: 844 };

const HOME = '/';

export const loc = (where = 'home', extra = {}) => ({
  where, tableId: null, room: null, since: Date.now() - 41 * 60_000, ...extra,
});

export const agent = (id, name, over = {}) => ({
  id,
  name,
  style: 'Balanced',
  risk: 'Medium',
...
export async function room(page, cast, viewport = VIEWPORT) {
