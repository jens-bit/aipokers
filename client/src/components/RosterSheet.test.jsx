...
describe('BUGS-A job 9 · where he is, in the room own words', () => {
  ...
  // BUG-209: Jens, playing 2026-09-14 — "The roster up to the right needs to
  ...
  it('BUG-209: names the category a coloured badge reads at a glance', () => {
...
describe('BUGS-A job 9 · the sheet', () => {
  it('BUG-209: a row at the casino wears a CASINO badge and a dimmed face; one at home does not', () => {
  ...
  it('BUG-230: the net figure carries a visible label, not just a hover title', () => {
