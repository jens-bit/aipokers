...
const NAMES = { day: 'Warm Day', dusk: 'Amber Dusk', night: 'Teal Night' };
...
export function HomeAppearanceProvider({ children }) {
  ...
  return <Appearance.Provider value={{ preference, period, theme: preference === 'auto' ? period : preference, choose }}>{children}</Appearance.Provider>;
}
