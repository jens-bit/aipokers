// Canonical mascot ghost — verbatim port of MoodGhost from design-refs/mood-atoms.jsx.
// Identity = accent (rim). Mood = eyes + glow. Never mixed.
// tone: full colour override for mood-driven parts (eyes + glow); marketing use only.
...
export function Ghost({ mood = 'neutral', accent = '#00D4AA', size = 40, ring = true, tone }) {
