...
export function WatchHero({
  name = null,
  hood = null, glow = null, equipment, bustedName = null, animateBust = false,
  ...
  return (
    <div className="watch-hero">
      ...
      <button type="button" className={`watch-hero__body${bustedName ? ' is-busted' : ''}`} onClick={onTapFace}
        ...
        <MoodGhost hood={hood} glow={glow} equipment={equipment} mood={mood} accent={accent} size={HERO_GHOST} heat={heat}
